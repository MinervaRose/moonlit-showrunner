...
## 1:30–2:10 — Edit plan and MP4 generation
Show the edit decision list and generate/export the MP4.

## 2:10–2:45 — Final video
Play the resulting short MP4.

## 2:45–3:00 — Architecture
Show the architecture diagram and explain the separation between the LLM story pipeline and the Python video assembly layer.
